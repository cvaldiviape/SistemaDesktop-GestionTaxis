 ...
 * @author SangreFx
 */
public class mensaje_registro_pago_pendiente extends javax.swing.JFrame {

    /**
     * Creates new form mensaje_registro_pago_pendiente
     */
    public mensaje_registro_pago_pendiente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDatosPesonalesChofer.setText("SE REGISTRO PAGO PENDIENTE!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_registro_pago_pendiente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensaje_registro_pago_pendiente().setVisible(true);
            }
        });
    }
