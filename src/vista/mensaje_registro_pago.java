 ...
 * @author SangreFx
 */
public class mensaje_registro_pago extends javax.swing.JFrame {

    /**
     * Creates new form mensaje_registro_pago
     */
    public mensaje_registro_pago() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDatosPesonalesChofer.setText("REGISTRO PAGO EXITOSAMENTE!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_registro_pago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensaje_registro_pago().setVisible(true);
            }
        });
    }
