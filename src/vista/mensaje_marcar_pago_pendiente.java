 ...
 * @author SangreFx
 */
public class mensaje_marcar_pago_pendiente extends javax.swing.JFrame {

    /**
     * Creates new form mensaje_marcar_pago_pendiente
     */
    public mensaje_marcar_pago_pendiente() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_marcar_pago_pendiente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensaje_marcar_pago_pendiente().setVisible(true);
            }
        });
    }
