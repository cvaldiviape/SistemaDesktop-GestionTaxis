 ...
 * @author SangreFx
 */
public class mensaje_seleccione_pago_pendiente extends javax.swing.JFrame {

    /**
     * Creates new form mensaje_seleccione_pago_pendiente
     */
    public mensaje_seleccione_pago_pendiente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDatosPesonalesChofer.setText("SELECCIONE PAGO PENDIENTE!!");
        lblDatosPesonalesChofer.setOpaque(true);
        jPanel1.add(lblDatosPesonalesChofer, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, 300, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_seleccione_pago_pendiente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensaje_seleccione_pago_pendiente().setVisible(true);
            }
        });
    }
