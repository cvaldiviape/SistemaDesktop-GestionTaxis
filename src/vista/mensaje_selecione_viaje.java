 ...
 * @author SangreFx
 */
public class mensaje_selecione_viaje extends javax.swing.JFrame {

    /**
     * Creates new form mensaje_selecione_viaje
     */
    public mensaje_selecione_viaje() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDatosPesonalesChofer.setText("NO HA SELECCIONADO VIAJE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_selecione_viaje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensaje_selecione_viaje().setVisible(true);
            }
        });
    }
