 ...
 * @author SangreFx
 */
public class mensaje_asignar_conductor extends javax.swing.JFrame {

    /**
     * Creates new form mensaje_necesitar_asignar_conductor
     */
    public mensaje_asignar_conductor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDatosPesonalesChofer.setText("FALTA SELECCIONAR AL CONDUCTOR!!");
        lblDatosPesonalesChofer.setOpaque(true);
        jPanel1.add(lblDatosPesonalesChofer, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 10, 350, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_asignar_conductor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensaje_asignar_conductor().setVisible(true);
            }
        });
    }
