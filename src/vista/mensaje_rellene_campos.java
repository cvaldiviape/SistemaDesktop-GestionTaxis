 ...
 * @author SangreFx
 */
public class mensaje_rellene_campos extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public mensaje_rellene_campos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDatosPesonalesChofer.setText("FALTA RELLENAR CAMPOS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_rellene_campos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensaje_rellene_campos().setVisible(true);
            }
        });
    }
