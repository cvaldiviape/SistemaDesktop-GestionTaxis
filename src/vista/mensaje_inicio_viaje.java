 ...
 * @author SangreFx
 */
public class mensaje_inicio_viaje extends javax.swing.JFrame {

    /**
     * Creates new form mensaje_inicio_viaje
     */
    public mensaje_inicio_viaje() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDatosPesonalesChofer.setText("SE INICIO VIAJE EXITOSAMENTE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_inicio_viaje.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensaje_inicio_viaje().setVisible(true);
            }
        });
    }
