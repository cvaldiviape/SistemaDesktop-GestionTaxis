 ...
 * @author SangreFx
 */
public class mensaje_actualizar_ok extends javax.swing.JFrame {

    /**
     * Creates new form mensaje_actualizar_ok
     */
    public mensaje_actualizar_ok() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDatosPesonalesChofer.setText("SE ACTUALIZO EXITOSAMENTE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_actualizar_ok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensaje_actualizar_ok().setVisible(true);
            }
        });
    }
