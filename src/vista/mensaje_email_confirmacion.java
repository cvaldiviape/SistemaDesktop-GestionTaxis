 ...
 * @author SangreFx
 */
public class mensaje_email_confirmacion extends javax.swing.JFrame {

    /**
     * Creates new form mensaje_email_confirmacion
     */
    public mensaje_email_confirmacion() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblDatosPesonalesChofer.setText("SE ENVIO EL CORREO SATISFACTORIAMENTE");
        lblDatosPesonalesChofer.setOpaque(true);
        jPanel1.add(lblDatosPesonalesChofer, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 400, 30));
    ...
    private void rSButtonRiple3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonRiple3ActionPerformed
        this.dispose();
        frame_email.getInstancia().dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mensaje_email_confirmacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mensaje_email_confirmacion().setVisible(true);
            }
        });
    }
